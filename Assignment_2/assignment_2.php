    ...
    <table style="width:100%; border: 20px solid #c7b700; border-collapse: collapse; color: #004a91">
        <tr>
            <td colspan="2" style="background-color: #004a91; padding: 50px; text-align:center">
                <h1 style="color: white; margin: 0;">Resume</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><textarea name="careerObj" rows="3" style="width: 100%;"></textarea></td>
        </tr>
        <tr>
            <td style="background-color: #d3d3d3; padding: 8px; font-weight: bold;">Key Skills: </td>
            <td><textarea name="skills" rows="3" style="width: 100%;"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="padding: 8px; font-weight: bold; text-align: center;"><button type="submit">Submit</button></td>
        </tr>
    </table>
</form>